...
static const _Seen_type_support_symbol_names_t _Seen_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tugas_yolo_yolocpp, msg, Seen)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tugas_yolo_yolocpp, msg, Seen)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tugas_yolo_yolocpp, msg, Seen)() {
  return &::tugas_yolo_yolocpp::msg::rosidl_typesupport_c::Seen_message_type_support_handle;
}
