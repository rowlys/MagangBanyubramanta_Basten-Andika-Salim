...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "tugas_opencv/msg/detail/position__type_support.h"
#include "tugas_opencv/msg/detail/position__struct.h"
#include "tugas_opencv/msg/detail/position__functions.h"

static void * tugas_opencv__msg__position__create_ros_message(void)
{
  return tugas_opencv__msg__Position__create();
}

static void tugas_opencv__msg__position__destroy_ros_message(void * raw_ros_message)
{
  tugas_opencv__msg__Position * ros_message = (tugas_opencv__msg__Position *)raw_ros_message;
  tugas_opencv__msg__Position__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool tugas_opencv__msg__position__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(tugas_opencv, msg, Position);
...
_register_msg_type__msg__position(PyObject * pymodule)
{
  ...
  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&tugas_opencv__msg__position__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&tugas_opencv__msg__position__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&tugas_opencv__msg__position__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&tugas_opencv__msg__position__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(tugas_opencv, msg, Position),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
...
PyMODINIT_FUNC
PyInit_tugas_opencv_s__rosidl_typesupport_fastrtps_c(void)
{
