...
{
  new (message_memory) tugas_joy::msg::Command(_init);
}

void Command_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tugas_joy::msg::Command *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_message_member_array[5] = {
  {
    ...
    offsetof(tugas_joy::msg::Command, x_cmd),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tugas_joy::msg::Command, y_cmd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tugas_joy::msg::Command, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tugas_joy::msg::Command, depth),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tugas_joy::msg::Command, x_button),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_message_members = {
  "tugas_joy::msg",  // message namespace
  "Command",  // message name
  5,  // number of fields
  sizeof(tugas_joy::msg::Command),
...
{
  return &::tugas_joy::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tugas_joy, msg, Command)() {
  return &::tugas_joy::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
