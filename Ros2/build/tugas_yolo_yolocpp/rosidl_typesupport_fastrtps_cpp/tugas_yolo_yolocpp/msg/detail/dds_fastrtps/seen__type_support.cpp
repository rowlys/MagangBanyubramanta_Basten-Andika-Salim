...
#include "tugas_yolo_yolocpp/msg/detail/seen__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tugas_yolo_yolocpp::msg::Seen;
    is_plain =
      (
      offsetof(DataType, flare) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tugas_yolo_yolocpp::msg::Seen *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tugas_yolo_yolocpp::msg::Seen *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Seen__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tugas_yolo_yolocpp::msg::Seen *>(
...
static size_t _Seen__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Seen(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Seen__callbacks = {
...
static rosidl_message_type_support_t _Seen__handle = {
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_tugas_yolo_yolocpp
const rosidl_message_type_support_t *
get_message_type_support_handle<tugas_yolo_yolocpp::msg::Seen>()
{
  return &tugas_yolo_yolocpp::msg::typesupport_fastrtps_cpp::_Seen__handle;
}
