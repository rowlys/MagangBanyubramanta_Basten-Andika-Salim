...
#include "xbox/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
#include "xbox/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Command__ros_msg_type = xbox__msg__Command;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xbox
size_t get_serialized_size_xbox__msg__Command(
  const void * untyped_ros_message,
...
static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xbox__msg__Command(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xbox
size_t max_serialized_size_xbox__msg__Command(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xbox__msg__Command;
    is_plain =
      (
...
static size_t _Command__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xbox__msg__Command(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xbox, msg, Command)() {
