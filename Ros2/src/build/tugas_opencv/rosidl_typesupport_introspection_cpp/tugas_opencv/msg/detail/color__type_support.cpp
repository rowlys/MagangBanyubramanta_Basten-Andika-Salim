...
{
  new (message_memory) tugas_opencv::msg::Color(_init);
}

void Color_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tugas_opencv::msg::Color *>(message_memory);
  typed_message->~Color();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Color_message_member_array[3] = {
  {
    ...
    offsetof(tugas_opencv::msg::Color, red),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tugas_opencv::msg::Color, blue),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::tugas_opencv::msg::rosidl_typesupport_introspection_cpp::Color_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tugas_opencv, msg, Color)() {
  return &::tugas_opencv::msg::rosidl_typesupport_introspection_cpp::Color_message_type_support_handle;
}
