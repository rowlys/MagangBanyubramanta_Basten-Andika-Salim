...
#include "xbox/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xbox::msg::Command;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xbox::msg::Command *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_xbox
const rosidl_message_type_support_t *
get_message_type_support_handle<xbox::msg::Command>()
{
  return &xbox::msg::typesupport_fastrtps_cpp::_Command__handle;
}
