...
bool tugas_opencv__msg__color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tugas_opencv.msg._color.Color", full_classname_dest, 29) == 0);
  }
  tugas_opencv__msg__Color * ros_message = _ros_message;
  {  // red
...
PyObject * tugas_opencv__msg__color__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tugas_opencv.msg._color");
