...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tugas_joy')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'tugas_joy.msg.Command')
            logger.debug(
...
class Command(metaclass=Metaclass_Command):
    ...
    def __init__(self, **kwargs):
        ...
        self.x_button = kwargs.get('x_button', int())
        self.y_button = kwargs.get('y_button', int())
    ...
    def __eq__(self, other):
        ...
        if self.depth != other.depth:
            return False
        if self.x_button != other.x_button:
            return False
        if self.y_button != other.y_button:
            return False
        return True
    ...
    def x_button(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'x_button' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'x_button' field must be an integer in [-2147483648, 2147483647]"
        self._x_button = value

    @builtins.property
    def y_button(self):
        """Message field 'y_button'."""
    ...
    def y_button(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'y_button' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'y_button' field must be an integer in [-2147483648, 2147483647]"
