...
class Init_Command_y_button
{
public:
  explicit Init_Command_y_button(::tugas_joy::msg::Command & msg)
  : msg_(msg)
  {}
  ::tugas_joy::msg::Command y_button(::tugas_joy::msg::Command::_y_button_type arg)
  {
    msg_.y_button = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Command_y_button x_button(::tugas_joy::msg::Command::_x_button_type arg)
  {
    msg_.x_button = std::move(arg);
    return Init_Command_y_button(msg_);
  }
