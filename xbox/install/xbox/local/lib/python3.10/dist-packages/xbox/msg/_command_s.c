...
bool xbox__msg__command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xbox.msg._command.Command", full_classname_dest, 25) == 0);
  }
  xbox__msg__Command * ros_message = _ros_message;
  {  // x_cmd
...
PyObject * xbox__msg__command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xbox.msg._command");
